                        ...
                        <div class="mdui-col-sm-12">
                            <div class="mdui-textfield mdui-textfield-floating-label">
                                ...
                                <textarea rows="8" cols="50" name="text" id="textarea" class="mdui-textfield-input"
                                          maxlength="<?php if (!empty($this->options->commentszs)): ?><?php $this->options->commentszs() ?><?php else: ?>1000<?php endif; ?>"
...
<?php if ($comments->have()): ?>
    ...
    <div class="mdui-chip shadow-A1" style="background-color: #ececec;">
        ...
        <span
            class="mdui-chip-title"><?php $this->commentsNum(_t('暂无评论'), _t('仅有一条评论'), _t('已有 %d 条评论')); ?></span>
    </div>
        ...
        <div class="mdui-card fillet-A1 shadow-A1 button-ts" id="<?php $comments->theId(); ?>">
            ...
            <div class="mdui-card-actions" style="padding: 0px;">
                <div class="mdui-float-right">
                    <div class="mdui-row mdui-row-gapless">
                    <span
                        class="comment-reply cp-<?php $comments->theId(); ?> text-muted comment-reply-link"><?php $comments->reply(
                        ...
                        ); ?></span><span id="cancel-comment-reply"
                                          class="cancel-comment-reply cl-<?php $comments->theId(); ?> text-muted comment-reply-link"
